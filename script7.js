...
let dataString7 = '10';
console.log(typeof dataString7);
let dataInteger = parseInt(dataString7);
console.log(dataInteger);
console.log(typeof dataInteger);

let dataString8 = '10.125'
console.log(typeof dataString8); 
let dataFloat = parseFloat(dataString8);
